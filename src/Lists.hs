...
prop_is_palindrome :: (Boolean bool, HasEq bool Int) => Property bool [Int]
...
prop_long_palindrome :: (Boolean bool, HasEq bool Int, HasOrd bool Int) => Int -> Property bool [Int]
prop_long_palindrome i = (Prop $ \xs -> i <=. length xs) ==> inverse prop_is_palindrome
