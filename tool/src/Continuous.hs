...
make_prop_is_positive :: (Boolean bool, HasOrd bool Double) => ((Double, Double) -> Double) -> Property bool (Double, Double)
...
prop_ackley :: (Boolean bool, HasOrd bool Double) => Property bool (Double, Double)
prop_ackley = make_prop_is_positive ackley
  where
    ackley (x, y) = 19 - 20 * exp (-0.2 * sqrt ((x^2 + y^2) / 2)) - exp ((cos (2*pi*x) + cos (2*pi*y)) / 2) + exp 1

prop_ackley_shifted_by :: (Boolean bool, HasOrd bool Double) => (Double, Double) -> Property bool (Double, Double)
...
prop_drop_wave :: (Boolean bool, HasOrd bool Double) => Property bool (Double, Double)
prop_drop_wave = make_prop_is_positive dropwave
  where
    dropwave (x, y) = 0.5 - (1 + cos (12 * sqrt (x^2 + y^2))) / (0.5 * (x^2 + y^2) + 2)

prop_drop_wave_shifted_by :: (Boolean bool, HasOrd bool Double) => (Double, Double) -> Property bool (Double, Double)
...
prop_rastrigin :: (Boolean bool, HasOrd bool Double) => Property bool (Double, Double)
prop_rastrigin = make_prop_is_positive rastrigin
  where
    rastrigin (x, y) = 19.5 + (x^2 - 10 * cos (2 * pi * x) + y^2 - 10 * cos (2 * pi * y))

prop_rastrigin_shifted_by :: (Boolean bool, HasOrd bool Double) => (Double, Double) -> Property bool (Double, Double)
